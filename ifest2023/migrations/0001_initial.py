...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('event', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='ifest2023.event')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('staffAuth', models.CharField(blank=True, max_length=100, null=True)),
